...
export default function CribbagePlay() {
  ...
  const threshold = session.config?.targetScore || 121;
  ...
  async function deleteRound(index) {
    ...
    try {
      ...
      const newTotals = recomputeTotals("cribbage", session, newRounds);
  ...
  return (
    <div>
      <h1 className="page-title">
        <span className="suit red">📍</span> Cribbage — Hand {rounds.length + 1}
      </h1>
