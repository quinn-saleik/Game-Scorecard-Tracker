    ...
    <div>
      ...
      <div className="card-surface">
        ...
        <p style={{ color: "var(--muted)", fontSize: 14 }}>
          Each hand, both teams bid how many of the 13 tricks they'll take (nil bids handled
          separately). A team that makes its combined bid scores 10 points per trick bid plus
          1 for every overtrick; a team that falls short goes negative by 10 times its bid
          instead. A player going Nil (bidding zero tricks alone) is worth +100 to their team
          if they take zero tricks, or −100 if they don't.
        </p>
        <p style={{ color: "var(--muted)", fontSize: 14 }}>
          Bag penalties (–100 every time a team's bags reach 10) aren't automatically tracked
          here — if your house plays with that rule, keep an eye on it yourselves.
        </p>
      </div>
